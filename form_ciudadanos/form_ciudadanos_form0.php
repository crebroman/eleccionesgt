...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_ciudadanos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ciudadanos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['recarga'];
}
?>
...
<?php
 include_once("form_ciudadanos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ciudadanos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ciudadanos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dpi_label" id="hidden_field_label_dpi" style="<?php echo $sStyleHidden_dpi; ?>"><span id="id_label_dpi"><?php echo $this->nm_new_label['dpi']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['dpi']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['dpi'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_primer_nombre_label" id="hidden_field_label_primer_nombre" style="<?php echo $sStyleHidden_primer_nombre; ?>"><span id="id_label_primer_nombre"><?php echo $this->nm_new_label['primer_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['primer_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['primer_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_primer_nombre_line" id="hidden_field_data_primer_nombre" style="<?php echo $sStyleHidden_primer_nombre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_primer_nombre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_segundo_nombre_label" id="hidden_field_label_segundo_nombre" style="<?php echo $sStyleHidden_segundo_nombre; ?>"><span id="id_label_segundo_nombre"><?php echo $this->nm_new_label['segundo_nombre']; ?></span></TD>
    <TD class="scFormDataOdd css_segundo_nombre_line" id="hidden_field_data_segundo_nombre" style="<?php echo $sStyleHidden_segundo_nombre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_segundo_nombre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tercer_nombre_label" id="hidden_field_label_tercer_nombre" style="<?php echo $sStyleHidden_tercer_nombre; ?>"><span id="id_label_tercer_nombre"><?php echo $this->nm_new_label['tercer_nombre']; ?></span></TD>
    <TD class="scFormDataOdd css_tercer_nombre_line" id="hidden_field_data_tercer_nombre" style="<?php echo $sStyleHidden_tercer_nombre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tercer_nombre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_primer_apellido_label" id="hidden_field_label_primer_apellido" style="<?php echo $sStyleHidden_primer_apellido; ?>"><span id="id_label_primer_apellido"><?php echo $this->nm_new_label['primer_apellido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['primer_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['primer_apellido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_primer_apellido_line" id="hidden_field_data_primer_apellido" style="<?php echo $sStyleHidden_primer_apellido; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_primer_apellido_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_segundo_apellido_label" id="hidden_field_label_segundo_apellido" style="<?php echo $sStyleHidden_segundo_apellido; ?>"><span id="id_label_segundo_apellido"><?php echo $this->nm_new_label['segundo_apellido']; ?></span></TD>
    <TD class="scFormDataOdd css_segundo_apellido_line" id="hidden_field_data_segundo_apellido" style="<?php echo $sStyleHidden_segundo_apellido; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_segundo_apellido_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_apellido_casada_label" id="hidden_field_label_apellido_casada" style="<?php echo $sStyleHidden_apellido_casada; ?>"><span id="id_label_apellido_casada"><?php echo $this->nm_new_label['apellido_casada']; ?></span></TD>
    <TD class="scFormDataOdd css_apellido_casada_line" id="hidden_field_data_apellido_casada" style="<?php echo $sStyleHidden_apellido_casada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_apellido_casada_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_residencia_label" id="hidden_field_label_direccion_residencia" style="<?php echo $sStyleHidden_direccion_residencia; ?>"><span id="id_label_direccion_residencia"><?php echo $this->nm_new_label['direccion_residencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_residencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_residencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_zona_label" id="hidden_field_label_direccion_zona" style="<?php echo $sStyleHidden_direccion_zona; ?>"><span id="id_label_direccion_zona"><?php echo $this->nm_new_label['direccion_zona']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_zona']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_zona'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_direccion_zona_line" id="hidden_field_data_direccion_zona" style="<?php echo $sStyleHidden_direccion_zona; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_zona_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_deptoid_label" id="hidden_field_label_direccion_deptoid" style="<?php echo $sStyleHidden_direccion_deptoid; ?>"><span id="id_label_direccion_deptoid"><?php echo $this->nm_new_label['direccion_deptoid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_deptoid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_deptoid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_direccion_deptoid_line" id="hidden_field_data_direccion_deptoid" style="<?php echo $sStyleHidden_direccion_deptoid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_deptoid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_municipioid_label" id="hidden_field_label_direccion_municipioid" style="<?php echo $sStyleHidden_direccion_municipioid; ?>"><span id="id_label_direccion_municipioid"><?php echo $this->nm_new_label['direccion_municipioid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_municipioid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['direccion_municipioid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_direccion_municipioid_line" id="hidden_field_data_direccion_municipioid" style="<?php echo $sStyleHidden_direccion_municipioid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_municipioid_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_sexo'][] = '1'; ?>
 <option value="0" <?php  if ($this->sexo == "0") { echo " selected" ;} ?>>Femenino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_sexo'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_civil_label" id="hidden_field_label_estado_civil" style="<?php echo $sStyleHidden_estado_civil; ?>"><span id="id_label_estado_civil"><?php echo $this->nm_new_label['estado_civil']; ?></span></TD>
    <TD class="scFormDataOdd css_estado_civil_line" id="hidden_field_data_estado_civil" style="<?php echo $sStyleHidden_estado_civil; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_civil_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado_civil'][] = '1'; ?>
 <option value="0" <?php  if ($this->estado_civil == "0") { echo " selected" ;} ?><?php  if (empty($this->estado_civil)) { echo " selected" ;} ?>>Soltero</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado_civil'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_label" id="hidden_field_label_estado" style="<?php echo $sStyleHidden_estado; ?>"><span id="id_label_estado"><?php echo $this->nm_new_label['estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['php_cmp_required']['estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado'][] = 'E'; ?>
 <option value="O" <?php  if ($this->estado == "O") { echo " selected" ;} ?><?php  if (empty($this->estado)) { echo " selected" ;} ?>>Operado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado'][] = 'O'; ?>
 <option value="F" <?php  if ($this->estado == "F") { echo " selected" ;} ?>>Fallecido</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado'][] = 'F'; ?>
 <option value="A" <?php  if ($this->estado == "A") { echo " selected" ;} ?>>Anulado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['Lookup_estado'][] = 'A'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudadanos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ciudadanos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ciudadanos");
 parent.scAjaxDetailHeight("form_ciudadanos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
