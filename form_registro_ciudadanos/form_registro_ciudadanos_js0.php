<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="dpi" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['dpi']); ?>">
<input type="hidden" name="numero_padron" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['numero_padron']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_registro_ciudadanos']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_registro_ciudadanos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_registro_ciudadanos']['where_detal']))
  {
?>  
