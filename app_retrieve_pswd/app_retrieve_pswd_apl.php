...
$sql = "SELECT email FROM public.sec_usuariosusers WHERE login = ".$this->Db->qstr($param_login);
...
$pswd =$this->act_code();
$sql  = "UPDATE public.sec_usuariosusers SET pswd = '". hash("md5",$pswd) ."' WHERE login = '". $this->sc_temp_usr_login ."'";
