...
else
{
    ...
    $_SESSION['scriptcase']['app_menu']['glo_nm_perfil']    = "conn_postgres";
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_registro_partidos") . "/form_registro_partidos_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_registro_partidos") . "/form_registro_partidos_ini.txt");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcandidatos") . "/form_tblcandidatos_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcandidatos") . "/form_tblcandidatos_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcargo") . "/form_tblcargo_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcargo") . "/form_tblcargo_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcentro_votacion") . "/form_tblcentro_votacion_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblcentro_votacion") . "/form_tblcentro_votacion_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tbldepartamento") . "/form_tbldepartamento_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tbldepartamento") . "/form_tbldepartamento_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblmesac") . "/form_tblmesac_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblmesac") . "/form_tblmesac_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblmunicipios") . "/form_tblmunicipios_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblmunicipios") . "/form_tblmunicipios_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_ciudadanos") . "/grid_public_ciudadanos_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_ciudadanos") . "/grid_public_ciudadanos_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_ciudadanos']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_registro_ciudadanos") . "/form_registro_ciudadanos_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_registro_ciudadanos") . "/form_registro_ciudadanos_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblparticipante") . "/form_tblparticipante_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tblparticipante") . "/form_tblparticipante_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_ingreso") . "/form_ingreso_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_ingreso") . "/form_ingreso_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_ingreso'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Maestro de Partidos Politicos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Maestro de Candidatos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Maestro de Cargos Politicos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Maestro de Centros De Votacion";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Maestro de Departamentos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Maestro Mesas Receptoras";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[6]))
{
 ...
 $nm_var_lab[7] = "Maestro de Municipios";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[8]))
{
 ...
 $nm_var_lab[9] = "Maestro De Ciudadanos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "Registro De Ciudadanos Padron Electoral";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "Recepcion de Votantes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[11]))
{
 ...
 $nm_var_lab[12] = "Ingreso Para Emitir Voto";
...
$app_menu_menuData['data'] .= "item_8|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos']) == "on")
{
    $app_menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[1] . "|app_menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_registro_partidos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos']) == "on")
{
    $app_menu_menuData['data'] .= "item_10|..|" . $nm_var_lab[2] . "|app_menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_tblcandidatos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo']) == "on")
{
    $app_menu_menuData['data'] .= "item_11|..|" . $nm_var_lab[3] . "|app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_tblcargo&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion']) == "on")
{
    $app_menu_menuData['data'] .= "item_12|..|" . $nm_var_lab[4] . "|app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=form_tblcentro_votacion&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento']) == "on")
{
    $app_menu_menuData['data'] .= "item_13|..|" . $nm_var_lab[5] . "|app_menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=form_tbldepartamento&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac']) == "on")
{
    $app_menu_menuData['data'] .= "item_15|..|" . $nm_var_lab[6] . "|app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_tblmesac&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios']) == "on")
{
    $app_menu_menuData['data'] .= "item_14|..|" . $nm_var_lab[7] . "|app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=form_tblmunicipios&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

$app_menu_menuData['data'] .= "item_5|.|" . $nm_var_lab[8] . "||" . $nm_var_hint[8] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_ciudadanos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_ciudadanos']) == "on")
{
    $app_menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[9] . "|app_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_public_ciudadanos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos']) == "on")
{
    $app_menu_menuData['data'] .= "item_7|..|" . $nm_var_lab[10] . "|app_menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=form_registro_ciudadanos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante']) == "on")
{
    $app_menu_menuData['data'] .= "item_16|..|" . $nm_var_lab[11] . "|app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=form_tblparticipante&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso']) == "on")
{
    $app_menu_menuData['data'] .= "item_17|..|" . $nm_var_lab[12] . "|app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=form_ingreso&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

$app_menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $app_menu_menuData['data'] .= "item_2|..|" . $this->Nm_lang['lang_change_pswd'] . "|app_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_list_users'] . "|app_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_registro_partidos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_registro_partidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_tblcandidatos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcandidatos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_tblcargo&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcargo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=form_tblcentro_votacion&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblcentro_votacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=form_tbldepartamento&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tbldepartamento']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_tblmesac&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblmesac']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=form_tblmunicipios&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblmunicipios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_public_ciudadanos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_ciudadanos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_ciudadanos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=form_registro_ciudadanos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_registro_ciudadanos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=form_tblparticipante&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tblparticipante']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=form_ingreso&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $app_menu_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    <td id="Iframe_control" style="border-width: 1px; height: 100%; padding: 0px;vertical-align:top;text-align:center;">
      <iframe id="iframe_app_menu" name="app_menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "app_menu_pag_ini.php"); ?>"></iframe>
<?php
}
?></td>
  </tr>
