...
class grid_public_ciudadanos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_ciudadanos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_ciudadanos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_ciudadanos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "public.ciudadanos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_ciudadanos/grid_public_ciudadanos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_ciudadanos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_ciudadanos_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - public.ciudadanos</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $dpi = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['dpi']; 
          $dpi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['dpi_cond']; 
          $primer_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_nombre']; 
          $primer_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_nombre_cond']; 
          $segundo_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['segundo_nombre']; 
          $segundo_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['segundo_nombre_cond']; 
          $primer_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_apellido']; 
          $primer_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_apellido_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_public_ciudadanos_help.txt"))
   {
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_primer_nombre"  <?php echo $str_hide_primer_nombre?>><?php
      $primer_nombre_look = substr($this->Db->qstr($primer_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_primer_nombre" name="primer_nombre" value="<?php echo NM_encode_input($primer_nombre) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_primer_nombre" name="primer_nombre_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_segundo_nombre"  <?php echo $str_hide_segundo_nombre?>><?php
      $segundo_nombre_look = substr($this->Db->qstr($segundo_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_segundo_nombre" name="segundo_nombre" value="<?php echo NM_encode_input($segundo_nombre) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_segundo_nombre" name="segundo_nombre_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_primer_apellido"  <?php echo $str_hide_primer_apellido?>><?php
      $primer_apellido_look = substr($this->Db->qstr($primer_apellido), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_primer_apellido" name="primer_apellido" value="<?php echo NM_encode_input($primer_apellido) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_primer_apellido" name="primer_apellido_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_ciudadanos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_ciudadanos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "temporal/grid_public_ciudadanos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_public_ciudadanos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      global $dpi_cond, $dpi, $dpi_autocomp,
             $primer_nombre_cond, $primer_nombre, $primer_nombre_autocomp,
             $segundo_nombre_cond, $segundo_nombre, $segundo_nombre_autocomp,
             $primer_apellido_cond, $primer_apellido, $primer_apellido_autocomp, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['dpi'] = $dpi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['dpi_cond'] = $dpi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_nombre'] = $primer_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_nombre_cond'] = $primer_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['segundo_nombre'] = $segundo_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['segundo_nombre_cond'] = $segundo_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_apellido'] = $primer_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['primer_apellido_cond'] = $primer_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_ciudadanos']['where_pesq_ant'] = $this->comando . $this->comando_fim;
