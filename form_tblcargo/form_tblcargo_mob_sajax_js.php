  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblcargo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo_cargo
  function do_ajax_form_tblcargo_mob_validate_tipo_cargo()
  {
    var nomeCampo_tipo_cargo = "tipo_cargo";
    var var_tipo_cargo = scAjaxGetFieldText(nomeCampo_tipo_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcargo_mob_validate_tipo_cargo(var_tipo_cargo, var_script_case_init, do_ajax_form_tblcargo_mob_validate_tipo_cargo_cb);
  } // do_ajax_form_tblcargo_mob_validate_tipo_cargo

  function do_ajax_form_tblcargo_mob_validate_tipo_cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_cargo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcargo_mob_validate_tipo_cargo_cb

  // ---------- Validate anio_electoral
  function do_ajax_form_tblcargo_mob_validate_anio_electoral()
  {
    var nomeCampo_anio_electoral = "anio_electoral";
    var var_anio_electoral = scAjaxGetFieldSelect(nomeCampo_anio_electoral);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcargo_mob_validate_anio_electoral(var_anio_electoral, var_script_case_init, do_ajax_form_tblcargo_mob_validate_anio_electoral_cb);
  } // do_ajax_form_tblcargo_mob_validate_anio_electoral

  function do_ajax_form_tblcargo_mob_validate_anio_electoral_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "anio_electoral";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcargo_mob_validate_anio_electoral_cb
  // ---------- Form
  function do_ajax_form_tblcargo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblcargo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo_cargo = scAjaxGetFieldText("tipo_cargo");
    var var_anio_electoral = scAjaxGetFieldSelect("anio_electoral");
    var var_idcargo = scAjaxGetFieldText("idcargo");
    ...
    scAjaxProcOn();
    x_ajax_form_tblcargo_mob_submit_form(var_tipo_cargo, var_anio_electoral, var_idcargo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblcargo_mob_submit_form_cb);
  } // do_ajax_form_tblcargo_mob_submit_form

  function do_ajax_form_tblcargo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipo_cargo");
      scAjaxHideErrorDisplay("anio_electoral");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tblcargo_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblcargo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo_cargo");
    scAjaxHideErrorDisplay("anio_electoral");
    var var_idcargo = document.F2.idcargo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblcargo_mob_navigate_form(var_idcargo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblcargo_mob_navigate_form_cb);
  } // do_ajax_form_tblcargo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcargo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblcargo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblcargo_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idcargo.value = scAjaxGetKeyValue("idcargo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tblcargo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblcargo_mob_navigate_form_cb
  function sc_hide_form_tblcargo_mob_form()
  {
  ...
  ajax_field_list[0] = "tipo_cargo";
  ajax_field_list[1] = "anio_electoral";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tipo_cargo": {"label": "Tipo Cargo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anio_electoral": {"label": "Año Electoral", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "tipo_cargo": new Array(),
    "anio_electoral": new Array()
  };
  ajax_field_mult["tipo_cargo"][1] = "tipo_cargo";
  ajax_field_mult["anio_electoral"][1] = "anio_electoral";

  var ajax_field_id = {
    "tipo_cargo": new Array("hidden_field_label_tipo_cargo", "hidden_field_data_tipo_cargo"),
    "anio_electoral": new Array("hidden_field_label_anio_electoral", "hidden_field_data_anio_electoral")
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tipo_cargo" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("anio_electoral" == sIndex)
    {
