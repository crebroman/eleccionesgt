  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblcargo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo_cargo
  function do_ajax_form_tblcargo_validate_tipo_cargo()
  {
    var nomeCampo_tipo_cargo = "tipo_cargo";
    var var_tipo_cargo = scAjaxGetFieldText(nomeCampo_tipo_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcargo_validate_tipo_cargo(var_tipo_cargo, var_script_case_init, do_ajax_form_tblcargo_validate_tipo_cargo_cb);
  } // do_ajax_form_tblcargo_validate_tipo_cargo

  function do_ajax_form_tblcargo_validate_tipo_cargo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcargo_validate_tipo_cargo_cb

  // ---------- Validate anio_electoral
  function do_ajax_form_tblcargo_validate_anio_electoral()
  {
    var nomeCampo_anio_electoral = "anio_electoral";
    var var_anio_electoral = scAjaxGetFieldSelect(nomeCampo_anio_electoral);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcargo_validate_anio_electoral(var_anio_electoral, var_script_case_init, do_ajax_form_tblcargo_validate_anio_electoral_cb);
  } // do_ajax_form_tblcargo_validate_anio_electoral

  function do_ajax_form_tblcargo_validate_anio_electoral_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcargo_validate_anio_electoral_cb
  // ---------- Form
  function do_ajax_form_tblcargo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblcargo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblcargo_submit_form(var_tipo_cargo, var_anio_electoral, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblcargo_submit_form_cb);
  } // do_ajax_form_tblcargo_submit_form

  function do_ajax_form_tblcargo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblcargo_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblcargo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblcargo_navigate_form(var_idcargo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblcargo_navigate_form_cb);
  } // do_ajax_form_tblcargo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcargo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblcargo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tblcargo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblcargo_navigate_form_cb
  function sc_hide_form_tblcargo_form()
  {
