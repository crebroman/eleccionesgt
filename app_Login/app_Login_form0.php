...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "); } else { echo strip_tags("INICIO"); } ?></TITLE>
...
<style>
#lin1_col1 { margin-left:9px; margin-top:7px;  width:70%; height:27px; float:left; overflow:hidden;}			 
#lin1_col2 { margin-right:9px; margin-top:7px; width:20%; height:27px; float:right; overflow:hidden; text-align:right;}
</style>

<div style="width: 100%" class="scFormHeader">
 <span style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px; display: block">
      <span id="lin1_col1" class="scFormHeaderFont"></span>
      <span id="lin1_col2" class="scFormHeaderFont" style="float: right"></span>
 </span>
</div>
</td></tr>
<?php
