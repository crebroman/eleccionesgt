  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblmesad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_tblmesad_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tblmesad_validate_id__cb);
  } // do_ajax_form_tblmesad_validate_id_

  function do_ajax_form_tblmesad_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesad_validate_id__cb

  // ---------- Validate cargo_
  function do_ajax_form_tblmesad_validate_cargo_(iNumLinha)
  {
    var nomeCampo_cargo_ = "cargo_" + iNumLinha;
    var var_cargo_ = scAjaxGetFieldSelect(nomeCampo_cargo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_validate_cargo_(var_cargo_, iNumLinha, var_script_case_init, do_ajax_form_tblmesad_validate_cargo__cb);
  } // do_ajax_form_tblmesad_validate_cargo_

  function do_ajax_form_tblmesad_validate_cargo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cargo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cargo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cargo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cargo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesad_validate_cargo__cb

  // ---------- Validate nombre_
  function do_ajax_form_tblmesad_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_tblmesad_validate_nombre__cb);
  } // do_ajax_form_tblmesad_validate_nombre_

  function do_ajax_form_tblmesad_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesad_validate_nombre__cb

  // ---------- Validate estado_
  function do_ajax_form_tblmesad_validate_estado_(iNumLinha)
  {
    var nomeCampo_estado_ = "estado_" + iNumLinha;
    var var_estado_ = scAjaxGetFieldSelect(nomeCampo_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_validate_estado_(var_estado_, iNumLinha, var_script_case_init, do_ajax_form_tblmesad_validate_estado__cb);
  } // do_ajax_form_tblmesad_validate_estado_

  function do_ajax_form_tblmesad_validate_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesad_validate_estado__cb

  // ---------- Validate idmesa_
  function do_ajax_form_tblmesad_validate_idmesa_(iNumLinha)
  {
    var nomeCampo_idmesa_ = "idmesa_" + iNumLinha;
    var var_idmesa_ = scAjaxGetFieldSelect(nomeCampo_idmesa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_validate_idmesa_(var_idmesa_, iNumLinha, var_script_case_init, do_ajax_form_tblmesad_validate_idmesa__cb);
  } // do_ajax_form_tblmesad_validate_idmesa_

  function do_ajax_form_tblmesad_validate_idmesa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idmesa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idmesa_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idmesa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idmesa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesad_validate_idmesa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblmesad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblmesad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblmesad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblmesad_add_new_line_cb);
  } // do_ajax_form_tblmesad_add_new_line

  function do_ajax_form_tblmesad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tblmesad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblmesad_backup_line(iNumLinha)
  {
    var var_idmesa_ = scAjaxGetFieldSelect("idmesa_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesad_backup_line(var_idmesa_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblmesad_backup_line_cb);
  } // do_ajax_form_tblmesad_backup_line

  function do_ajax_form_tblmesad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_tblmesad_backup_line_cb

  function do_ajax_form_tblmesad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblmesad_cancel_insert

  function do_ajax_form_tblmesad_cancel_update(iSeqVert)
  {
    do_ajax_form_tblmesad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblmesad_cancel_update

  function do_ajax_form_tblmesad_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblmesad_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblmesad_table_refresh()
  {
    var var_idmesa_ = document.F2.idmesa_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblmesad_table_refresh(var_idmesa_, var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmesad_table_refresh_cb);
  } //  do_ajax_form_tblmesad_table_refresh

  function do_ajax_form_tblmesad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idmesa_.value = scAjaxGetKeyValue("idmesa_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblmesad_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblmesad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblmesad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_cargo_ = scAjaxGetFieldSelect("cargo_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_estado_ = scAjaxGetFieldSelect("estado_" + iNumLinha);
    var var_idmesa_ = scAjaxGetFieldSelect("idmesa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tblmesad_submit_form(var_id_, var_cargo_, var_nombre_, var_estado_, var_idmesa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblmesad_submit_form_cb);
  } // do_ajax_form_tblmesad_submit_form

  function do_ajax_form_tblmesad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblmesad_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblmesad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblmesad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblmesad_navigate_form(var_idmesa_, var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmesad_navigate_form_cb);
  } // do_ajax_form_tblmesad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblmesad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblmesad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idmesa_.value = scAjaxGetKeyValue("idmesa_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_tblmesad_navigate_form_cb
  function sc_hide_form_tblmesad_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tblmesad_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["cargo_" + iNumLinha] = {"label": "Cargo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idmesa_" + iNumLinha] = {"label": "Idmesa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["cargo_"][iNumLinha] = "cargo_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["estado_"][iNumLinha] = "estado_" + iNumLinha;
    ajax_field_mult["idmesa_"][iNumLinha] = "idmesa_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["cargo_" + iNumLinha] = new Array("hidden_field_label_cargo_", "hidden_field_data_cargo_" + iNumLinha);
...
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["cargo_" + iNumLinha] = "on";
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["cargo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cargo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cargo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cargo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cargo_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idmesa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idmesa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idmesa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idmesa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idmesa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cargo_'])) ? $this->nmgp_cmp_readonly['cargo_'] : 'off';
?>
    scAjaxFieldRead("cargo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idmesa_'])) ? $this->nmgp_cmp_readonly['idmesa_'] : 'on';
?>
    scAjaxFieldRead("idmesa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("cargo_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("estado_" + iSeq, "on");
    scAjaxFieldRead("idmesa_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["cargo_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["estado_" + iRow] || "on" == ajax_error_count["idmesa_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_cargo_" + iRow))
        document.getElementById("hidden_field_data_cargo_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_nombre_" + iRow))
        document.getElementById("hidden_field_data_nombre_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_estado_" + iRow))
        document.getElementById("hidden_field_data_estado_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_idmesa_" + iRow))
        document.getElementById("hidden_field_data_idmesa_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["cargo_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["estado_" + iRow] && "off" == ajax_error_count["idmesa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["cargo_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["estado_" + iRow] = "off";
        ajax_error_count["idmesa_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_cargo_" + iRow))
        document.getElementById("hidden_field_data_cargo_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_nombre_" + iRow))
        document.getElementById("hidden_field_data_nombre_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_estado_" + iRow))
        document.getElementById("hidden_field_data_estado_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_idmesa_" + iRow))
        document.getElementById("hidden_field_data_idmesa_" + iRow).className = sCssLine;
    }
  }
