...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Centros De Votacion"); } else { echo strip_tags("Centros De Votacion"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tblcentro_votacion/form_tblcentro_votacion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tblcentro_votacion_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tblcentro_votacion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['recarga'];
}
?>
...
<?php
 include_once("form_tblcentro_votacion_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tblcentro_votacion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tblcentro_votacion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:55px; border-width:0px 0px 3px 0px;  border-style:solid; border-color:#ddd; display: block">
    ...
    <tr>
		<td id="lin1_col1" class="scFormHeaderFont"><span><?php echo "CENTROS DE VOTACION" ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['idcentro']))
           {
               $this->nmgp_cmp_readonly['idcentro'] = 'on';
           }
?>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['idcentro']))
    {
        $this->nm_new_label['idcentro'] = "Idcentro";
    }
?>
<?php
   ...
   $sStyleHidden_idcentro = '';
   if (isset($this->nmgp_cmp_hidden['idcentro']) && $this->nmgp_cmp_hidden['idcentro'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['idcentro']);
       $sStyleHidden_idcentro = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_idcentro = 'display: none;';
   $sStyleReadInp_idcentro = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["idcentro"]) &&  $this->nmgp_cmp_readonly["idcentro"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['idcentro']);
       $sStyleReadLab_idcentro = '';
       $sStyleReadInp_idcentro = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['idcentro']) && $this->nmgp_cmp_hidden['idcentro'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="idcentro" value="<?php echo $this->form_encode_input($idcentro) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_idcentro_label" id="hidden_field_label_idcentro" style="<?php echo $sStyleHidden_idcentro; ?>"><span id="id_label_idcentro"><?php echo $this->nm_new_label['idcentro']; ?></span></TD>
    <TD class="scFormDataOdd css_idcentro_line" id="hidden_field_data_idcentro" style="<?php echo $sStyleHidden_idcentro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcentro_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idcentro" class="css_idcentro_line" style="<?php echo $sStyleReadLab_idcentro; ?>"><?php echo $this->form_encode_input($this->idcentro); ?></span><span id="id_read_off_idcentro" style="<?php echo $sStyleReadInp_idcentro; ?>"><input type="hidden" name="idcentro" value="<?php echo $this->form_encode_input($idcentro) . "\">"?><span id="id_ajax_label_idcentro"><?php echo nl2br($idcentro); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idcentro_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idcentro_text"></span></td></tr></table></td></tr></table></TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<span id="id_read_on_direccion" class="sc-ui-readonly-direccion css_direccion_line" style="<?php echo $sStyleReadLab_direccion; ?>"><?php echo $this->form_encode_input($this->direccion); ?></span><span id="id_read_off_direccion" style="white-space: nowrap;<?php echo $sStyleReadInp_direccion; ?>">
 ...
 size=80 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_departamento_line" id="hidden_field_data_departamento" style="<?php echo $sStyleHidden_departamento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_departamento_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_departamento\" class=\"css_departamento_line\" style=\"" .  $sStyleReadLab_departamento . "\">" . $this->form_encode_input($departamento_look) . "</span><span id=\"id_read_off_departamento\" style=\"" . $sStyleReadInp_departamento . "\">";
   echo " <span id=\"idAjaxSelect_departamento\"><select class=\"sc-js-input scFormObjectOdd css_departamento_obj\" style=\"\" id=\"id_sc_field_departamento\" name=\"departamento\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_municipio_line" id="hidden_field_data_municipio" style="<?php echo $sStyleHidden_municipio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_municipio_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['Lookup_estado'][] = 'A'; ?>
 <option value="I" <?php  if ($this->estado == "I") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['Lookup_estado'][] = 'I'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tblcentro_votacion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tblcentro_votacion");
 parent.scAjaxDetailHeight("form_tblcentro_votacion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
