  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblcentro_votacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcentro
  function do_ajax_form_tblcentro_votacion_validate_idcentro()
  {
    var nomeCampo_idcentro = "idcentro";
    var var_idcentro = scAjaxGetFieldHidden(nomeCampo_idcentro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_idcentro(var_idcentro, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_idcentro_cb);
  } // do_ajax_form_tblcentro_votacion_validate_idcentro

  function do_ajax_form_tblcentro_votacion_validate_idcentro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcentro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_idcentro_cb

  // ---------- Validate descripcion
  function do_ajax_form_tblcentro_votacion_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_descripcion_cb);
  } // do_ajax_form_tblcentro_votacion_validate_descripcion

  function do_ajax_form_tblcentro_votacion_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_descripcion_cb

  // ---------- Validate direccion
  function do_ajax_form_tblcentro_votacion_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_direccion_cb);
  } // do_ajax_form_tblcentro_votacion_validate_direccion

  function do_ajax_form_tblcentro_votacion_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_direccion_cb

  // ---------- Validate departamento
  function do_ajax_form_tblcentro_votacion_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldSelect(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_departamento(var_departamento, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_departamento_cb);
  } // do_ajax_form_tblcentro_votacion_validate_departamento

  function do_ajax_form_tblcentro_votacion_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_departamento_cb

  // ---------- Validate municipio
  function do_ajax_form_tblcentro_votacion_validate_municipio()
  {
    var nomeCampo_municipio = "municipio";
    var var_municipio = scAjaxGetFieldSelect(nomeCampo_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_municipio(var_municipio, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_municipio_cb);
  } // do_ajax_form_tblcentro_votacion_validate_municipio

  function do_ajax_form_tblcentro_votacion_validate_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_municipio_cb

  // ---------- Validate estado
  function do_ajax_form_tblcentro_votacion_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblcentro_votacion_validate_estado(var_estado, var_script_case_init, do_ajax_form_tblcentro_votacion_validate_estado_cb);
  } // do_ajax_form_tblcentro_votacion_validate_estado

  function do_ajax_form_tblcentro_votacion_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_validate_estado_cb

  // ---------- Refresh departamento
  function do_ajax_form_tblcentro_votacion_refresh_departamento()
  {
    var var_departamento = scAjaxGetFieldSelect("departamento");
    var var_nmgp_refresh_fields = "municipio";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblcentro_votacion_refresh_departamento(var_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tblcentro_votacion_refresh_departamento_cb);
  } // do_ajax_form_tblcentro_votacion_refresh_departamento

  function do_ajax_form_tblcentro_votacion_refresh_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblcentro_votacion_refresh_departamento_cb
  // ---------- Form
  function do_ajax_form_tblcentro_votacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblcentro_votacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcentro = scAjaxGetFieldHidden("idcentro");
    ...
    scAjaxProcOn();
    x_ajax_form_tblcentro_votacion_submit_form(var_idcentro, var_descripcion, var_direccion, var_departamento, var_municipio, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblcentro_votacion_submit_form_cb);
  } // do_ajax_form_tblcentro_votacion_submit_form

  function do_ajax_form_tblcentro_votacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcentro");
...
?>
  ...
  } // do_ajax_form_tblcentro_votacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblcentro_votacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("municipio");
    scAjaxHideErrorDisplay("estado");
    var var_idcentro = document.F2.idcentro.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblcentro_votacion_navigate_form(var_idcentro, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblcentro_votacion_navigate_form_cb);
  } // do_ajax_form_tblcentro_votacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblcentro_votacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblcentro_votacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblcentro_votacion_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idcentro.value = scAjaxGetKeyValue("idcentro");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tblcentro_votacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblcentro_votacion_navigate_form_cb
  function sc_hide_form_tblcentro_votacion_form()
  {
  ...
  ajax_field_list[0] = "idcentro";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "direccion";
  ...
  var ajax_error_list = {
    "idcentro": {"label": "Idcentro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idcentro"][1] = "idcentro";
  ...
  var ajax_field_id = {
    "idcentro": new Array("hidden_field_label_idcentro", "hidden_field_data_idcentro"),
