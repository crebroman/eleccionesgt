  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblmesac" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblmesac_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tblmesac_validate_descripcion_cb);
  } // do_ajax_form_tblmesac_validate_descripcion

  function do_ajax_form_tblmesac_validate_descripcion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_validate_descripcion_cb

  // ---------- Validate centro_votacionid
  function do_ajax_form_tblmesac_validate_centro_votacionid()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_validate_centro_votacionid(var_centro_votacionid, var_script_case_init, do_ajax_form_tblmesac_validate_centro_votacionid_cb);
  } // do_ajax_form_tblmesac_validate_centro_votacionid

  function do_ajax_form_tblmesac_validate_centro_votacionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_validate_centro_votacionid_cb

  // ---------- Validate detalle
  function do_ajax_form_tblmesac_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_tblmesac_validate_detalle_cb);
  } // do_ajax_form_tblmesac_validate_detalle

  function do_ajax_form_tblmesac_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "detalle";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_validate_detalle_cb
  // ---------- Form
  function do_ajax_form_tblmesac_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblmesac_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblmesac_submit_form(var_descripcion, var_centro_votacionid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblmesac_submit_form_cb);
  } // do_ajax_form_tblmesac_submit_form

  function do_ajax_form_tblmesac_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblmesac_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tblmesad"] = "off";

  function do_ajax_form_tblmesac_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblmesad"] = "on";
    x_ajax_form_tblmesac_navigate_form(var_idmesa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmesac_navigate_form_cb);
  } // do_ajax_form_tblmesac_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblmesac']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblmesac_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad"] && "nmsc_iframe_liga_form_tblmesad" != scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblmesad').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_tblmesad').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_tblmesad').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_tblmesac_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblmesac_navigate_form_cb
  function sc_hide_form_tblmesac_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblmesad"])
    {
      return true;
    }
    return false;
