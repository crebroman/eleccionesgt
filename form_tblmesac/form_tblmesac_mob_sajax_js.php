  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblmesac_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblmesac_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tblmesac_mob_validate_descripcion_cb);
  } // do_ajax_form_tblmesac_mob_validate_descripcion

  function do_ajax_form_tblmesac_mob_validate_descripcion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_mob_validate_descripcion_cb

  // ---------- Validate centro_votacionid
  function do_ajax_form_tblmesac_mob_validate_centro_votacionid()
  {
    var nomeCampo_centro_votacionid = "centro_votacionid";
    var var_centro_votacionid = scAjaxGetFieldSelect(nomeCampo_centro_votacionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_mob_validate_centro_votacionid(var_centro_votacionid, var_script_case_init, do_ajax_form_tblmesac_mob_validate_centro_votacionid_cb);
  } // do_ajax_form_tblmesac_mob_validate_centro_votacionid

  function do_ajax_form_tblmesac_mob_validate_centro_votacionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "centro_votacionid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_mob_validate_centro_votacionid_cb

  // ---------- Validate detalle
  function do_ajax_form_tblmesac_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmesac_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_tblmesac_mob_validate_detalle_cb);
  } // do_ajax_form_tblmesac_mob_validate_detalle

  function do_ajax_form_tblmesac_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "detalle";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmesac_mob_validate_detalle_cb
  // ---------- Form
  function do_ajax_form_tblmesac_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblmesac_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_centro_votacionid = scAjaxGetFieldSelect("centro_votacionid");
    var var_idmesa = scAjaxGetFieldText("idmesa");
    ...
    scAjaxProcOn();
    x_ajax_form_tblmesac_mob_submit_form(var_descripcion, var_centro_votacionid, var_idmesa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblmesac_mob_submit_form_cb);
  } // do_ajax_form_tblmesac_mob_submit_form

  function do_ajax_form_tblmesac_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("centro_votacionid");
...
?>
  ...
  } // do_ajax_form_tblmesac_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tblmesad_mob"] = "off";

  function do_ajax_form_tblmesac_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("centro_votacionid");
    scAjaxHideErrorDisplay("detalle");
    var var_idmesa = document.F2.idmesa.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblmesad_mob"] = "on";
    x_ajax_form_tblmesac_mob_navigate_form(var_idmesa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmesac_mob_navigate_form_cb);
  } // do_ajax_form_tblmesac_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblmesac_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblmesac_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblmesac_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idmesa.value = scAjaxGetKeyValue("idmesa");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad_mob"] && "nmsc_iframe_liga_form_tblmesad_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblmesad_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblmesad_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_tblmesad_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_tblmesad_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_tblmesac_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblmesac_mob_navigate_form_cb
  function sc_hide_form_tblmesac_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblmesad_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "descripcion";
  ajax_field_list[1] = "centro_votacionid";
  ...
  var ajax_error_list = {
    ...
    "centro_votacionid": {"label": "Centro Votacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
