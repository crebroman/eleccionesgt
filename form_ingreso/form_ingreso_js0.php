...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_ingreso']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_ingreso"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_cmdingreso = false;
function sc_btn_cmdingreso()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_cmdingreso(); }, 500);
      return;
    }
    if (Crtl_btn_cmdingreso) {return;}
    Crtl_btn_cmdingreso = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?cmdingreso?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ingreso']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "form_ingreso_fim.php";
   document.F4.submit(); 
} 
