...
$old_error_handler = set_error_handler("form_tbldepartamento_scriptcase_error_handler");

function form_tbldepartamento_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbldepartamento']['contr_erro']) && $_SESSION['scriptcase']['form_tbldepartamento']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbldepartamento->contr_form_tbldepartamento->Apl_com_erro = true;
            if ($inicial_form_tbldepartamento->contr_form_tbldepartamento->NM_ajax_flag)
            {
                $inicial_form_tbldepartamento->contr_form_tbldepartamento->NM_ajax_info['errList']['geral_form_tbldepartamento'][] = $msg;
                return;
            }
            form_tbldepartamento_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbldepartamento_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbldepartamento'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbldepartamento'])  ? $_SESSION['scriptcase']['error_icon']['form_tbldepartamento']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_tbldepartamento']) && '' != $_SESSION['scriptcase']['error_close']['form_tbldepartamento']) ? $_SESSION['scriptcase']['error_close']['form_tbldepartamento'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbldepartamento']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbldepartamento']) ? $_SESSION['scriptcase']['error_span_title']['form_tbldepartamento'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbldepartamento']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbldepartamento']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbldepartamento'] : '';
?>
