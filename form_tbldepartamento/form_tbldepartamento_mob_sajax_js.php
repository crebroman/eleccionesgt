  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbldepartamento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tbldepartamento_mob_validate_departamentoid()
  {
    var nomeCampo_departamentoid = "departamentoid";
    var var_departamentoid = scAjaxGetFieldHidden(nomeCampo_departamentoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbldepartamento_mob_validate_departamentoid(var_departamentoid, var_script_case_init, do_ajax_form_tbldepartamento_mob_validate_departamentoid_cb);
  } // do_ajax_form_tbldepartamento_mob_validate_departamentoid

  function do_ajax_form_tbldepartamento_mob_validate_departamentoid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbldepartamento_mob_validate_departamentoid_cb

  // ---------- Validate departamentonom
  function do_ajax_form_tbldepartamento_mob_validate_departamentonom()
  {
    var nomeCampo_departamentonom = "departamentonom";
    var var_departamentonom = scAjaxGetFieldText(nomeCampo_departamentonom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbldepartamento_mob_validate_departamentonom(var_departamentonom, var_script_case_init, do_ajax_form_tbldepartamento_mob_validate_departamentonom_cb);
  } // do_ajax_form_tbldepartamento_mob_validate_departamentonom

  function do_ajax_form_tbldepartamento_mob_validate_departamentonom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "departamentonom";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbldepartamento_mob_validate_departamentonom_cb

  // ---------- Validate estado
  function do_ajax_form_tbldepartamento_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbldepartamento_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_tbldepartamento_mob_validate_estado_cb);
  } // do_ajax_form_tbldepartamento_mob_validate_estado

  function do_ajax_form_tbldepartamento_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbldepartamento_mob_validate_estado_cb
  // ---------- Form
  function do_ajax_form_tbldepartamento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbldepartamento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_departamentoid = scAjaxGetFieldHidden("departamentoid");
    var var_departamentonom = scAjaxGetFieldText("departamentonom");
    ...
    scAjaxProcOn();
    x_ajax_form_tbldepartamento_mob_submit_form(var_departamentoid, var_departamentonom, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbldepartamento_mob_submit_form_cb);
  } // do_ajax_form_tbldepartamento_mob_submit_form

  function do_ajax_form_tbldepartamento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("departamentonom");
...
?>
  ...
  } // do_ajax_form_tbldepartamento_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbldepartamento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("departamentonom");
    scAjaxHideErrorDisplay("estado");
    var var_departamentoid = document.F2.departamentoid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbldepartamento_mob_navigate_form(var_departamentoid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbldepartamento_mob_navigate_form_cb);
  } // do_ajax_form_tbldepartamento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbldepartamento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbldepartamento_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbldepartamento_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.departamentoid.value = scAjaxGetKeyValue("departamentoid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tbldepartamento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbldepartamento_mob_navigate_form_cb
  function sc_hide_form_tbldepartamento_mob_form()
  {
  ...
  ajax_field_list[0] = "departamentoid";
  ajax_field_list[1] = "departamentonom";
  ajax_field_list[2] = "estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "departamentoid": {"label": "Departamentoid", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "departamentonom": {"label": "Departamentonom", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "departamentonom": new Array(),
    "estado": new Array()
  };
  ajax_field_mult["departamentoid"][1] = "departamentoid";
  ajax_field_mult["departamentonom"][1] = "departamentonom";
  ...
  var ajax_field_id = {
    ...
    "departamentonom": new Array("hidden_field_label_departamentonom", "hidden_field_data_departamentonom"),
