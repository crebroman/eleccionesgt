  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblparticipante" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cui
  function do_ajax_form_tblparticipante_validate_cui()
  {
    var nomeCampo_cui = "cui";
    var var_cui = scAjaxGetFieldText(nomeCampo_cui);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblparticipante_validate_cui(var_cui, var_script_case_init, do_ajax_form_tblparticipante_validate_cui_cb);
  } // do_ajax_form_tblparticipante_validate_cui

  function do_ajax_form_tblparticipante_validate_cui_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblparticipante_validate_cui_cb

  // ---------- Event onblur cui
  function do_ajax_form_tblparticipante_event_cui_onblur()
  {
    var var_cui = scAjaxGetFieldText("cui");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblparticipante_event_cui_onblur(var_cui, var_script_case_init, do_ajax_form_tblparticipante_event_cui_onblur_cb);
  } // do_ajax_form_tblparticipante_event_cui_onblur

  function do_ajax_form_tblparticipante_event_cui_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cui";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tblparticipante_event_cui_onblur_cb
  // ---------- Form
  function do_ajax_form_tblparticipante_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblparticipante_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cui = scAjaxGetFieldText("cui");
    ...
    scAjaxProcOn();
    x_ajax_form_tblparticipante_submit_form(var_cui, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblparticipante_submit_form_cb);
  } // do_ajax_form_tblparticipante_submit_form

  function do_ajax_form_tblparticipante_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblparticipante_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblparticipante_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblparticipante_navigate_form(var_cui, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblparticipante_navigate_form_cb);
  } // do_ajax_form_tblparticipante_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblparticipante']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblparticipante_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblparticipante_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_tblparticipante_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblparticipante_navigate_form_cb
  function sc_hide_form_tblparticipante_form()
  {
