  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblvoto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcargo
  function do_ajax_form_tblvoto_mob_validate_idcargo()
  {
    var nomeCampo_idcargo = "idcargo";
    var var_idcargo = scAjaxGetFieldSelect(nomeCampo_idcargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblvoto_mob_validate_idcargo(var_idcargo, var_script_case_init, do_ajax_form_tblvoto_mob_validate_idcargo_cb);
  } // do_ajax_form_tblvoto_mob_validate_idcargo

  function do_ajax_form_tblvoto_mob_validate_idcargo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblvoto_mob_validate_idcargo_cb

  // ---------- Validate idpartido
  function do_ajax_form_tblvoto_mob_validate_idpartido()
  {
    var nomeCampo_idpartido = "idpartido";
    var var_idpartido = scAjaxGetFieldSelect(nomeCampo_idpartido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblvoto_mob_validate_idpartido(var_idpartido, var_script_case_init, do_ajax_form_tblvoto_mob_validate_idpartido_cb);
  } // do_ajax_form_tblvoto_mob_validate_idpartido

  function do_ajax_form_tblvoto_mob_validate_idpartido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpartido";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblvoto_mob_validate_idpartido_cb
  // ---------- Form
  function do_ajax_form_tblvoto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblvoto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcargo = scAjaxGetFieldSelect("idcargo");
    var var_idpartido = scAjaxGetFieldSelect("idpartido");
    var var_cuiparticipante = scAjaxGetFieldText("cuiparticipante");
    ...
    scAjaxProcOn();
    x_ajax_form_tblvoto_mob_submit_form(var_idcargo, var_idpartido, var_cuiparticipante, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblvoto_mob_submit_form_cb);
  } // do_ajax_form_tblvoto_mob_submit_form

  function do_ajax_form_tblvoto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcargo");
      scAjaxHideErrorDisplay("idpartido");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tblvoto_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblvoto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idcargo");
    scAjaxHideErrorDisplay("idpartido");
    var var_cuiparticipante = document.F2.cuiparticipante.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblvoto_mob_navigate_form(var_cuiparticipante, var_idcargo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblvoto_mob_navigate_form_cb);
  } // do_ajax_form_tblvoto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblvoto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblvoto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblvoto_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.cuiparticipante.value = scAjaxGetKeyValue("cuiparticipante");
...
{
?>
    do_ajax_form_tblvoto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblvoto_mob_navigate_form_cb
  function sc_hide_form_tblvoto_mob_form()
  {
  ...
  ajax_field_list[0] = "idcargo";
  ajax_field_list[1] = "idpartido";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idcargo": {"label": "CARGO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpartido": {"label": "PARTIDO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idcargo"][1] = "idcargo";
  ajax_field_mult["idpartido"][1] = "idpartido";

  var ajax_field_id = {
    "idcargo": new Array("hidden_field_label_idcargo", "hidden_field_data_idcargo"),
    "idpartido": new Array("hidden_field_label_idpartido", "hidden_field_data_idpartido")
  };
