  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblvoto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcargo
  function do_ajax_form_tblvoto_validate_idcargo()
  {
    var nomeCampo_idcargo = "idcargo";
    var var_idcargo = scAjaxGetFieldSelect(nomeCampo_idcargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblvoto_validate_idcargo(var_idcargo, var_script_case_init, do_ajax_form_tblvoto_validate_idcargo_cb);
  } // do_ajax_form_tblvoto_validate_idcargo

  function do_ajax_form_tblvoto_validate_idcargo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblvoto_validate_idcargo_cb

  // ---------- Validate idpartido
  function do_ajax_form_tblvoto_validate_idpartido()
  {
    var nomeCampo_idpartido = "idpartido";
    var var_idpartido = scAjaxGetFieldSelect(nomeCampo_idpartido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblvoto_validate_idpartido(var_idpartido, var_script_case_init, do_ajax_form_tblvoto_validate_idpartido_cb);
  } // do_ajax_form_tblvoto_validate_idpartido

  function do_ajax_form_tblvoto_validate_idpartido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblvoto_validate_idpartido_cb
  // ---------- Form
  function do_ajax_form_tblvoto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblvoto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblvoto_submit_form(var_idcargo, var_idpartido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblvoto_submit_form_cb);
  } // do_ajax_form_tblvoto_submit_form

  function do_ajax_form_tblvoto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblvoto_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblvoto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblvoto_navigate_form(var_cuiparticipante, var_idcargo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblvoto_navigate_form_cb);
  } // do_ajax_form_tblvoto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblvoto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblvoto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tblvoto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblvoto_navigate_form_cb
  function sc_hide_form_tblvoto_form()
  {
