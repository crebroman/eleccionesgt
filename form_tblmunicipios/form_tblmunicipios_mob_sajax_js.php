  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblmunicipios_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblmunicipios_mob_validate_departamentoid()
  {
    ...
    x_ajax_form_tblmunicipios_mob_validate_departamentoid(var_departamentoid, var_script_case_init, do_ajax_form_tblmunicipios_mob_validate_departamentoid_cb);
  } // do_ajax_form_tblmunicipios_mob_validate_departamentoid

  function do_ajax_form_tblmunicipios_mob_validate_departamentoid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmunicipios_mob_validate_departamentoid_cb

  // ---------- Validate municipionom
  function do_ajax_form_tblmunicipios_mob_validate_municipionom()
  {
    var nomeCampo_municipionom = "municipionom";
    var var_municipionom = scAjaxGetFieldText(nomeCampo_municipionom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmunicipios_mob_validate_municipionom(var_municipionom, var_script_case_init, do_ajax_form_tblmunicipios_mob_validate_municipionom_cb);
  } // do_ajax_form_tblmunicipios_mob_validate_municipionom

  function do_ajax_form_tblmunicipios_mob_validate_municipionom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "municipionom";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmunicipios_mob_validate_municipionom_cb
  // ---------- Form
  function do_ajax_form_tblmunicipios_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblmunicipios_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_departamentoid = scAjaxGetFieldSelect("departamentoid");
    var var_municipionom = scAjaxGetFieldText("municipionom");
    ...
    scAjaxProcOn();
    x_ajax_form_tblmunicipios_mob_submit_form(var_departamentoid, var_municipionom, var_municipioid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblmunicipios_mob_submit_form_cb);
  } // do_ajax_form_tblmunicipios_mob_submit_form

  function do_ajax_form_tblmunicipios_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("municipionom");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tblmunicipios_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblmunicipios_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_municipioid = document.F2.municipioid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblmunicipios_mob_navigate_form(var_departamentoid, var_municipioid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmunicipios_mob_navigate_form_cb);
  } // do_ajax_form_tblmunicipios_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblmunicipios_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblmunicipios_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblmunicipios_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.departamentoid.value = scAjaxGetKeyValue("departamentoid");
    document.F2.municipioid.value = scAjaxGetKeyValue("municipioid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tblmunicipios_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblmunicipios_mob_navigate_form_cb
  function sc_hide_form_tblmunicipios_mob_form()
  {
  ...
  ajax_field_list[1] = "municipionom";
  ...
  var ajax_error_list = {
    ...
    "municipionom": {"label": "Nombre Municipio ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "municipionom": new Array()
  };
  ajax_field_mult["departamentoid"][1] = "departamentoid";
  ajax_field_mult["municipionom"][1] = "municipionom";

  var ajax_field_id = {
    "departamentoid": new Array("hidden_field_label_departamentoid", "hidden_field_data_departamentoid"),
    "municipionom": new Array("hidden_field_label_municipionom", "hidden_field_data_municipionom")
  };
