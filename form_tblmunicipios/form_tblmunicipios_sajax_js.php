  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblmunicipios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblmunicipios_validate_departamentoid()
  {
    ...
    x_ajax_form_tblmunicipios_validate_departamentoid(var_departamentoid, var_script_case_init, do_ajax_form_tblmunicipios_validate_departamentoid_cb);
  } // do_ajax_form_tblmunicipios_validate_departamentoid

  function do_ajax_form_tblmunicipios_validate_departamentoid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmunicipios_validate_departamentoid_cb

  // ---------- Validate municipionom
  function do_ajax_form_tblmunicipios_validate_municipionom()
  {
    var nomeCampo_municipionom = "municipionom";
    var var_municipionom = scAjaxGetFieldText(nomeCampo_municipionom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblmunicipios_validate_municipionom(var_municipionom, var_script_case_init, do_ajax_form_tblmunicipios_validate_municipionom_cb);
  } // do_ajax_form_tblmunicipios_validate_municipionom

  function do_ajax_form_tblmunicipios_validate_municipionom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblmunicipios_validate_municipionom_cb
  // ---------- Form
  function do_ajax_form_tblmunicipios_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblmunicipios_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblmunicipios_submit_form(var_departamentoid, var_municipionom, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblmunicipios_submit_form_cb);
  } // do_ajax_form_tblmunicipios_submit_form

  function do_ajax_form_tblmunicipios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tblmunicipios_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tblmunicipios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblmunicipios_navigate_form(var_departamentoid, var_municipioid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblmunicipios_navigate_form_cb);
  } // do_ajax_form_tblmunicipios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblmunicipios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblmunicipios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblmunicipios_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_tblmunicipios_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblmunicipios_navigate_form_cb
  function sc_hide_form_tblmunicipios_form()
  {
