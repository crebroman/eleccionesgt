...
<?php
 ...
 if ("N" == $this->priv_admin) { $priv_admin_look = "" . $this->Ini->Nm_lang['lang_opt_no'] . "";} 
?>
<span id="id_read_on_priv_admin"  class="css_priv_admin_line" style="<?php echo $sStyleReadLab_priv_admin; ?>"><?php echo $this->form_encode_input($priv_admin_look); ?></span><span id="id_read_off_priv_admin" style="<?php echo $sStyleReadInp_priv_admin; ?>"><div id="idAjaxRadio_priv_admin" style="display: inline-block">
<TABLE><TR>
  <TD class="scFormDataFontOdd css_priv_admin_line">    <input  type=radio name="priv_admin" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'Y'; ?>
<?php  if ("Y" == $this->priv_admin)  { echo " checked" ;} ?>  onClick="" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
  <TD class="scFormDataFontOdd css_priv_admin_line">    <input  type=radio name="priv_admin" value="N"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'N'; ?>
<?php  if ("N" == $this->priv_admin)  { echo " checked" ;} ?><?php  if (empty($this->priv_admin)) { echo " checked" ;} ?>  onClick="" ><?php echo $this->Ini->Nm_lang['lang_opt_no']; ?></TD>
</TR></TABLE>
</div>
</span><?php  }?>
 </TD>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']))) {
